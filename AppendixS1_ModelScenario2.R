...
# Saving data
Ests_df %>% write_csv("model2_estimates.csv")
Ests_P_df %>% write_csv("model2_reachestimates.csv") # reach-specific estimates
p_df %>% write_csv("model2_detectionprobability.csv")
N_State_recs_df %>% write_csv("model2_Nfishstate.csv")
runtimes %>% write_csv("model2_runtimes.csv")